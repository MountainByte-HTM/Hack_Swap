...
const SearchByAuthor = () => {
  ...
  const searchByAuthor = async () => {
    setLoading(true);
    try {
      const response = await axios.post("https://2ba3-2401-4900-50ab-a2ec-f1dc-b1b5-e703-2f8c.ngrok-free.app/search", {
        author: author,
      });
  ...
  return (
    <div className="container mx-auto p-6 bg-brown-50 min-h-screen">
      <h1 className="text-4xl font-bold text-center text-brown-800 mb-8">Search Books by Author</h1>
